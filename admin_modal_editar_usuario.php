<?php 
	require ('db.php');
	$id_usuario = $_POST['input_id_usuario_editar'];
...
echo '<div class="modal fade" id="modal_editar_perfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	      ...
	      <div class="modal-body">
	          ...
	          <div class="form-row">
	            <div class=" form-group col-12">
	              ...
	              <input name="id_usuario" type="hidden" id="input_id_usuario" value="'. $id_usuario .'">
	            </div>
	          </div>
	          <div class="form-row">
	            <div class=" form-group col-12">
	          ...
	          <div class="form-row">
	            <div class=" form-group col-12">
	              ...
	              <input name="dni" type="text" class="form-control" placeholder="Ingrese su dni" id="input_dni" value="'. $dni .'">
	            </div>
	          </div>
	          <div class="form-row">
	            <div class=" form-group col-12">
	          ...
	          <div class="form-row">
	            <div class=" form-group col-12">
	              ...
	              <select id="select_carrera" name="carrera" class="form-control input-sm">';  
      						if($carreras->num_rows > 0){
						    	...
						    	while ($carrera =  mysqli_fetch_assoc($carreras)) {
						    		...
						    		echo '<option value= '. $carrera['id_carrera'].' '.$selected.'>'. utf8_encode($carrera['carrera']) .'</option>';		
						    	}
						    }else{
